...
class Cluster(object):
    ...
    def fit(self, X, y=None):
        ...
        for sample, label in zip(X, y):
            ...
            # Extract values
            avgWindowSize = sample.avgWindowSize

            # Get the number of matching clusters
            clusters = [self.dict_avgWindowSize.get(avgWindowSize)]
            ...
            if all(c is not None for c in clusters):
                ...
                # Case 1b: Destination and certificate -> different clusters
                    ...
                    for c in clusters:
                        ...
                        for value in c.avgWindowSizes:
                            if value is not None:
                                self.dict_avgWindowSize[value] = cluster
            ...
            if avgWindowSize is not None:
                self.dict_avgWindowSize[avgWindowSize] = cluster
    ...
    def predict_single(self, X):
        ...
        return self.dict_avgWindowSize.get(X.avgWindowSize, NetworkDestination(-1)).identifier
    ...
    def clusters(self):
        """Return a set of NetworkDestinations in the current cluster object.
            ...
            """
        clusters  = set(self.dict_avgWindowSize.values())
        return clusters
